...
const SCHOOL_TYPES = ['고등학교', '중학교', '교사연수'];
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="space-y-8">
          {portfolioData.timeline.map((item, index) => {
            ...
            const schoolEvents = item.events.filter((event) =>
              SCHOOL_TYPES.includes(event.type)
            );
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 space-y-4">
                  {schoolEvents.map((event, eventIndex) => (
                    <motion.div
                      key={eventIndex}
                      initial={{ opacity: 0, y: 20 }}
